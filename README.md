...
| **All metadata** | Everything in Privacy (same for JPEG — AllMetadata ≡ Privacy for ICC), plus PNG color-management chunks (`gAMA`, `cHRM`, `sRGB`) | JPEG JFIF; PNG `pHYs` (physical dimensions) |
